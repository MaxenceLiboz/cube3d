...
/*   Updated: 2022/04/28 11:01:42 by mliboz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_color(t_texture *texture, t_draw *draw, int index)
{
	...
	// dprintf(2, "%s\n", &texture[index].addr[draw->texture_x_pos * texture[index].line_length + draw->texture_y_pos * (texture[index].bits_per_pixel / 8)]);
