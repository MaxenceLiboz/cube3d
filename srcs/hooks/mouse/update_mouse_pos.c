...
/*   Updated: 2022/05/06 11:34:26 by mliboz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool	new_cell_pos(t_prg *prg, int x, int y)
{
	...
	old_pos.x = prg->mouse.mouse_position.x / prg->e_map.cell_size;
	old_pos.y = prg->mouse.mouse_position.y / prg->e_map.cell_size;
	new_pos.x = x / prg->e_map.cell_size;
	new_pos.y = y / prg->e_map.cell_size;
